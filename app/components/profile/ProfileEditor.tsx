          ...
          <div className="rounded-lg overflow-hidden bg-gray-800/50 mb-12 p-6">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-3 sm:grid-cols-6 gap-2 mt-4">
                ...
                {/* Added new daisy stickers */}
                <div 
                  className={`border-2 rounded-md p-1 cursor-pointer transition-all ${
                    formValues.sticker?.image === '/images/stickers/daisy-purple.png' 
                      ? 'border-cyan-500' 
                      : 'border-gray-700 hover:border-gray-500'
                  }`}
                  onClick={() => handleStickerChange('/images/stickers/daisy-purple.png')}
                >
                  <div className="aspect-square relative overflow-hidden rounded">
                    <div className="absolute inset-0 flex items-center justify-center bg-purple-900/20">
                      <img 
                        src="/images/stickers/daisy-purple.png" 
                        alt="Purple Daisy Sticker" 
                        className="w-10 h-10 object-contain"
                      />
                    </div>
                  </div>
                  <p className="text-xs text-center mt-1 text-gray-300">Purple Daisy</p>
                </div>
                
                <div 
                  className={`border-2 rounded-md p-1 cursor-pointer transition-all ${
                    formValues.sticker?.image === '/images/stickers/daisy-white.png' 
                      ? 'border-cyan-500' 
                      : 'border-gray-700 hover:border-gray-500'
                  }`}
                  onClick={() => handleStickerChange('/images/stickers/daisy-white.png')}
                >
                  <div className="aspect-square relative overflow-hidden rounded">
                    <div className="absolute inset-0 flex items-center justify-center bg-gray-700/20">
                      <img 
                        src="/images/stickers/daisy-white.png" 
                        alt="White Daisy Sticker" 
                        className="w-10 h-10 object-contain"
                      />
                    </div>
                  </div>
                  <p className="text-xs text-center mt-1 text-gray-300">White Daisy</p>
                </div>
                
                {/* One remaining placeholder for future stickers */}
                <div className="border-2 border-gray-700 hover:border-gray-500 rounded-md p-1 cursor-default opacity-50">
                  ...
                  <p className="text-xs text-center mt-1 text-gray-500">More coming!</p>
                </div>
              </div>
              
              <p className="text-xs text-gray-400 mt-3">
                Select a sticker to add a decorative touch to your profile.
              </p>
            </div>
          </div>
        </div>
